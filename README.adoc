...
image:https://img.shields.io/static/v1?label=by&message=DomainConnectDDNS-Python&color=blue[link=https://github.com/Domain-Connect/DomainConnectDDNS-Python,float="left"]
...
image:https://img.shields.io/static/v1?label=by&message=Image Docker&color=green[link=https://hub.docker.com/r/goodlinux/dnsupdater,float="left"]
